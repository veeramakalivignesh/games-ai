...
extern "C" {
    void *new_bot() { return new BotInterface(); }

    void find_best_move(BotInterface *bot, int **gameStateArr, int numRows, int numColumns, bool isBlackTurn, char *responseMoveBuffer) {
